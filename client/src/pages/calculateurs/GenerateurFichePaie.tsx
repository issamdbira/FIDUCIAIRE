    ...
    <div className="max-w-3xl mx-auto py-8 px-4">
            ...
            <Card className="p-8 rounded-lg shadow-sm border border-border bg-card space-y-5">
              ...
              <div className="border-t border-border pt-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <label className="flex items-center gap-2 px-4 py-2 border border-dashed border-primary/40 rounded-lg cursor-pointer text-primary hover:bg-primary/5">
          ...
          {etape === 3 && (
            <Card className="p-8 rounded-lg shadow-sm border border-border bg-card space-y-5">
                  ...
                  <div key={el.id} className="flex items-end gap-2 p-3 bg-muted/50 rounded-lg">
                    ...
                    <div className="w-32">
                      ...
                      {el.type === "salaire_base" && validerMontantSalaire(el.montant) && (
                        <p className="text-xs text-destructive mt-1">{validerMontantSalaire(el.montant)}</p>
                      )}
                    </div>
                    <Button variant="ghost" size="icon" onClick={() => supprimerElement(el.id)} className="text-destructive hover:text-destructive/80 mb-1">
              ...
              <Button variant="outline" onClick={ajouterElement} className="gap-2 border-primary/40 text-primary">
