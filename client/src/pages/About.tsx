    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          {/* Titre */}
          <h1 className="text-5xl font-bold text-foreground mb-6" style={{ fontFamily: "Montserrat, sans-serif" }}>
            À Propos de LE FIDUCIAIRE
          </h1>

          {/* Mission */}
          <Card className="p-8 border-0 shadow-sm mb-8 bg-primary/5 dark:bg-primary/10">
          ...
          {/* Calculateurs */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-6" style={{ fontFamily: "Montserrat, sans-serif" }}>
              Nos Calculateurs
            </h2>
          ...
          {/* Disclaimer */}
          <Card className="p-8 border-0 shadow-sm bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700">
            <h2 className="text-xl font-bold text-yellow-900 dark:text-yellow-200 mb-4" style={{ fontFamily: "Montserrat, sans-serif" }}>
              ⚠️ Avis Important
            </h2>
          ...
          <div className="mt-12 text-center">
            ...
            <Link href="/">
              <Button className="text-primary-foreground font-semibold py-3 px-8">
      ...
      {/* Footer */}
      <footer className="bg-blue-900 dark:bg-slate-800 text-white py-8 mt-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-6 mt-4 md:mt-0">
              <a href="#" className="text-blue-100 dark:text-slate-300 hover:text-white transition-colors">
                Mentions légales
              </a>
              <a href="#" className="text-blue-100 dark:text-slate-300 hover:text-white transition-colors">
                Confidentialité
