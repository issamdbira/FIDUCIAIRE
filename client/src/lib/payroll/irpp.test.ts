...
import { reinitialiserPayrollConfig, getPayrollConfig } from "@/lib/payroll/config";
...
describe("IRPP — calculs", () => {
  ...
  describe("calculerIRPPAnnuel", () => {
    it("retourne 0 pour une assiette fiscale nulle ou négative", () => {
      ...
      expect(calculerIRPPAnnuel(5000, 6000)).toBe(0);
    });
  ...
  describe("Edge cases", () => {
    ...
    it("autres déductions annuelle sont ajoutées", () => {
